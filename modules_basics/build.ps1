...
# Compile module B
&($javac_path) --module-path "output\moduleA\lib\" -d $classB $(Get-ChildItem .\com.module.client  -Recurse -Filter '*.java' -File | %{ $_.FullName})

#packages module B
&($jar_path)  -c -f "output\moduleB\lib\moduleBuser.jar"  --main-class com.module.client.Client  -C "output\ModuleB\classesB" .
